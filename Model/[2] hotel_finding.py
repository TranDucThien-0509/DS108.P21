...
# Đọc dữ liệu
df = pd.read_csv(r'C:\Users\Admin\Documents\Đại học\DS108 - Tiền xử lý và Xây dựng bộ dữ liệu\Data\Gold Data\Gold_Data.csv')
...
ngay_HCM = ['29-30', '30-1', '1-2', '2-3']
ngay_BMT = ['3-4', '4-5', '5-6']
